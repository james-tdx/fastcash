...
export function Footer () {
    ...
    return (
        ...
        <div className=" grid grid-cols-1 pl-25 md:grid-cols-2 lg:grid-cols-4 md:pl-30 lg:pl-30">
            <div>
                <p className="text-white font-bold text-2xl mb-2 pt-2">FastCash</p>
            ...
            <div>
                <p className="text-white font-bold text-2xl mb-2 pt-2">Financial Services</p>
            ...
            <div>
                <p className="text-2xl font-bold text-white mb-2 pt-2">Legal</p>
            ...
            <div>
                <p className="text-2xl font-bold text-white mb-2 pt-2">Socials</p>
